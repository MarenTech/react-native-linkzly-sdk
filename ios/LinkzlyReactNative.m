...
RCT_EXPORT_METHOD(trackInstall:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
    [LinkzlyReactNativeSwift trackInstallWithResolver:resolve
                                             rejecter:reject];
}

RCT_EXPORT_METHOD(trackOpen:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
    [LinkzlyReactNativeSwift trackOpenWithResolver:resolve
                                          rejecter:reject];
}
...
RCT_EXPORT_METHOD(trackEventBatch:(NSArray *)events
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(getUserID:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
    [LinkzlyReactNativeSwift getUserIDWithResolver:resolve
                                          rejecter:reject];
}

RCT_EXPORT_METHOD(setTrackingEnabled:(BOOL)enabled
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(isTrackingEnabled:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
    [LinkzlyReactNativeSwift isTrackingEnabledWithResolver:resolve
                                                  rejecter:reject];
}

RCT_EXPORT_METHOD(getVisitorID:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
    [LinkzlyReactNativeSwift getVisitorIDWithResolver:resolve
                                             rejecter:reject];
}

RCT_EXPORT_METHOD(resetVisitorID:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
    [LinkzlyReactNativeSwift resetVisitorIDWithResolver:resolve
                                               rejecter:reject];
}
...
RCT_EXPORT_METHOD(setAdvertisingTrackingEnabled:(BOOL)enabled
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(isAdvertisingTrackingEnabled:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(getIDFA:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
    [LinkzlyReactNativeSwift getIDFAWithResolver:resolve
                                         rejecter:reject];
}

RCT_EXPORT_METHOD(getATTStatus:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
    [LinkzlyReactNativeSwift getATTStatusWithResolver:resolve
                                            rejecter:reject];
}

// MARK: - Flush Events and Pending Count

RCT_EXPORT_METHOD(flushEvents:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
    [LinkzlyReactNativeSwift flushEventsWithResolver:resolve
                                            rejecter:reject];
}

RCT_EXPORT_METHOD(getPendingEventCount:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(debugSetBatchingStrategy:(NSString *)strategy
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(debugSetBatchSize:(NSInteger)size
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(debugSetFlushInterval:(double)interval
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(debugSimulateServerConfig:(NSInteger)batchSize
...
RCT_EXPORT_METHOD(debugResetConfig:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
    [LinkzlyReactNativeSwift debugResetConfigWithResolver:resolve
                                                 rejecter:reject];
}

RCT_EXPORT_METHOD(debugPrintConfig:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
    [LinkzlyReactNativeSwift debugPrintConfigWithResolver:resolve
                                                 rejecter:reject];
}

RCT_EXPORT_METHOD(debugGetConfig:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
    [LinkzlyReactNativeSwift debugGetConfigWithResolver:resolve
                                               rejecter:reject];
}
